import { defineComponent, ref, computed, onMounted, inject, h } from 'vue';
...
export const SignInForm = defineComponent({
    ...
    setup(props) {
        ...
        const activeTab = ref(props.mode || 'signin');
        ...
        return () => {
            ...
            if (showLoading.value) {
                ...
                children.push(h('div', { class: 'space-y-3' }, enabledProviderIds.value.map((id) => getProviderButton(id)).filter(Boolean)));
            }
            // Terms
            children.push(h('p', {
