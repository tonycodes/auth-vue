    ...
    setup(props) {
        ...
        return () => {
            ...
            if (props.autoFetch && !props.providers && providersLoading.value) {
                children.push(h('div', { class: 'flex items-center justify-center py-4' }, [
            ...
            if (showEmail.value && !providersLoading.value) {
                ...
                if (enabledProviders.value.length > 0) {
                    emailChildren.push(h('div', { class: 'flex items-center gap-3 my-5' }, [
                ...
                if (emailSent.value) {
                    emailChildren.push(h('div', { class: 'text-center py-3' }, [
                    ...
                    formChildren.push(h('input', {
                        ...
                        class: `w-full px-4 py-3 rounded-xl border bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${emailError.value ? 'border-red-300' : 'border-zinc-300'}`,
                    }));
                    if (emailError.value) {
                        formChildren.push(h('p', { class: 'text-xs text-red-600' }, emailError.value));
                    }
                    formChildren.push(h('button', {
                        type: 'submit',
                    ...
                    if (emailApiError.value) {
                        formChildren.push(h('p', { class: 'text-xs text-red-600' }, emailApiError.value));
                    }
                    emailChildren.push(h('form', {
